...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--isize', type=int, default=224, help='input image size.')
        ...
        self.parser.add_argument('--ngf', type=int, default=2048)
        self.parser.add_argument('--ndf', type=int, default=2048)
